...
* 3D print any 3D printed parts *(Steps 31, 32, 63)*
...
**Step 32:**
If you have a 3D printer, you can download the stl file **(include link)** or contact us through email (as25glea@siena.edu) to request to have us send you a 3D printed LED holder. Trace the circle on the inside of the LED holder on the inside of the circle you traced from the absorber weight. Cut a hole in the center of the circle you traced so that you can make a ring (see Figure 10).
