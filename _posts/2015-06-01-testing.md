...
* 3D print any 3D printed parts
* Soak The Absorber in water and let it dry
* Put together the mounting board with the trim, stained and finished
...
**Step 7:**
Solder Black Wire 2 and Green Wire 1 together. Then put electrical tape around them. Make sure no other stripped wires are touching different color wires. Now use a zip tie to group together all the wires from the 24 pin adapter and the mesh wire organizer. 

>* **NOTE:** 
Click [here](https://m.youtube.com/watch?v=XQvxXMlhOeo) to learn how solder wires together and then put heat shrink over the wires. Applying the heat shrink will be necessary for the other wires later on. For now just pay attention to how to solder wires together and instead of putting heat shrink over the stripped part of the wires, just put electrical tape to cover them. 

**Step 8:** 
Put a zip tie around the wires and mesh wire organizer right before the end of the cut mesh wire organizer. Tape around the mesh wire organizer, zip ties and wires all together with electrical tape (See Figures 2 and 3). 
...
>* **NOTE:**
It does not matter what length it is, we just cut the mesh wire organizers a smaller length for asthetics.

**Step 11:**
Cut the wires to be about the same length of the mesh wire organizers and repeat Steps 6 and 7 for the rest of the wire adapters that are not needed. You can group like colors from th rest of the groups of wires that are not used. Each group does not have to be done seperately when using electical tape to group like color wires. Once you put the tape around each group of unneeded wires, put a zip tie around all of them (look at Figure 4).
...
**Step 13:**
Once the fan works on the power supply, place the CPU cooler (Cooler Master Hyper D92) so that the pipes are on your left and right side and the fan is facing you as you are facing the CPU cooler (see Figure 7). Also make sure the wire with the 4 pin adapters from the CPU Cooler is on the side closest to the power supply.

>**Step 14:**
Slide the heat shrink down Yellow Wire 2 and Black Wire 3 before soldering. Look to the note in Step 7 to learn how to solder wires and apply heat shrink over the stripped soldered parts of the wires. 
...
**Step 20:**
To connect the power supply to the CPU Cooler, you should cut 4 1.5 inch (including 1/2 inch striped parts) connector wires that are stripped at both ends. These will connect the two 4 pin adapters from the CPU Cooler to the power supply. Figure 8 shows you where to connect the yellow and black wires in the 4 pin adapters. In the HYPER D92 CPU Cooler you will need to attach 2 half inch connector wires to solder to Yellow Wire 1. Then do the same for Black Wire 1 because there are two 4 pin adapters (we suggest using 2 yellow connector wires to connect to Yellow Wire 1 from the power supply and 2 black connector wires to connect to Black Wire 1 from the power supply to make things less confusing). 
...
**Step 22:**
Solder Red Wire 1 (5V) from the power supply to the red wire on the 12709 peltier and solder Black Wire 4 (ground) from the power supply to the black wire on the 12709 peltier.
...
>**Step 25:**
You can contact us by email (as25glea@siena.edu) to request project panel pieces, or you can cut them yourself. Use a hot wire cutter to cut 3 pieces of project panel to keep the peltier in place on the CPU cooler. Figure 9 shows the dimensions for the project panel.

**Add figure**
*Figure 9. The dimensions of each piece of project panel with the Cooler Master HYPER D92.*

**Step 26:** 
Position the 3 pieces of project panel around the peltier coolers so that there is an opening in the wires. The project panel should be the same level as the peltiers (look at Figure 10). Make sure it fits nicely around the peltier coolers. Now hot glue the 2 shorter pieces to the loner piece and lay ti around the peltier. You may need to adjust the sizing of the project panel. 

>**Step 27:**
Cut a piece of kapton tape and place it over the peltiers to keep them in place. For the HYPER D92 CPU Cooler you should only use one piece of tape and have it lay perpendicular to the wires from the peltier and wrap it around one of the pipes on each side (shown in Figures 10 and 11).
...
>**Step 31:**
If you have a 3D printer, you can download the stl file **(include link)** or contact us through email (as25glea@siena.edu) to request to have us send you a 3D printed absorber weight. Trace it onto The Absorber (when it is dry).

**Step 32:**
If you have a 3D printer, you can download the stl file **(include link)** or contact us through email (as25glea@siena.edu) to request to have us send you a 3D printed LED holder. Trace the circle on the inside of the LED holder on the inside of the circle you traced from the absorber weight. Cut a hole in the center of the circle you traced so that you can make a ring. 

>**Step 33:**
Wet The Absorber ring. When attaching it to the inside of the petri dish, place the petri dish on a glasses cleaner cloth or peice of printer paper so it does not get scratched. We put epoxy on a peice of left over wood and used a popsicle stick to mix it and then applied it to the petri dish. Put a thin layer of epoxy with a popsicle stick on the inside outer edge of the petri dish without the spray paint. Place the wet The Absorber ring on the epoxy in the petri dish. Then put the 3D printed absorber weight on top of it with a textbook (or something similar in weight) on top of the absorber weight. This will ensure The Absorber ring dries flat on the petri dish. It will take about 2-3 days to dry. 
...
**Step 35:**
Cut the LED strip where it is needed and use epoxy to attach the LED strip to the inside of the LED holder. We put epoxy on a peice of left over wood and used a popsicle stick to mix it and then applied it to the back of the LED strip. Then we put it on the inside of the LED holder right at the edge of it and used binder clips to hold the LED strip in place until it dried. 

>**Step 36:**
Solder and apply the heat shrink to the red wire coming from the LED strip once it is secured in the LED holder with the wires already through the wire hole to Yellow Wire 3. Also solder and apply the heat shrink the black/white/grey wire from the LED strip to Black Wire 5. 
...
* **NOTE:**
Use a guiding rail and a woodworking square to make a straight cut through the plywood. It is also best to have the side you will not be mounting everything on facing up when you cut the plywood with the circular saw. 

>**Step 44:**
Cut the trim into 2 peices that are 11 1/4 inches (from inner part to inner part) and 2 peices that are 15 inches (from inner part to inner part) with a miter saw (look at Figure 13). Make sure they fit around the plywood and match up in all four corners. If they do not, adjust and cut/sand accordingly. If there are small gaps in the corners where they meet you can use wood filler later on. 
...
>* **NOTE:**
It might be best to mark one hole where the bolt should go in one mending plate on the mounting board, drill that hole and then place the power supply where shown in the template again and mending plate over it with a bolt through the hole onto the mounting board and mark where the second hole for the other bolt should be drilled for that mending plate. This will just be to ensure the holes for the 2 bolts on one mending plate are in the right place. Repeat this process for the other mending plate as well.
...
**Step 55:**
Place the gooseneck where it is shown on the template. You may need to move the gooseneck to a different spot. Make sure this is a good spot for the gooseneck to be so that it is easy to place the LED holder around the petri dish on the CPU cooler. 
...
>**Step 60:**
Stain the mounting board (trim is now glued on plywood with wood filler if necessary) and let it dry. We used Minwax English Chestnut Wood Finish and found it was easiest to apply with a sponge brush. Follow the instructions for application and how long it should dry that are given on the container of the type of stain you use. 
...
>**Step 62:**
Once the finish has dried, you can sand it again and put on another coat. 

**Step 63:** 
Once the mounting board is done and dry, mount the CPU Cooler, power supply and gooseneck again like you did before. 

>**Step 64:**
Cut an 7.5 inch and 12 inch piece of tubing. Wrap the 12 inch piece around the 2 wires connecting to the LED strip and wrap the 7.5 inch piece around the wires connecting to the peltiers.
